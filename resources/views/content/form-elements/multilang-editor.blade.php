<div class="mt-3">
  <button class="btn btn-xs btn-label-primary mb-2" onclick="{{ route('api.get-library-images') }}" method="GET" type="button" id="addMediaButton" data-bs-toggle="modal" data-bs-target="#modalAddMedia">
