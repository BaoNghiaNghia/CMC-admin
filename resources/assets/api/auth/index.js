...
const fetchProfileDetail = (data, config) => AuthenticateApi.createBasicCRUDEndpoints({ name: DETAIL_PROFILE_ENDPOINT }).get(data, config);
const updateProfileDetail = (data) => AuthenticateApi.createBasicCRUDEndpoints({ name: DETAIL_PROFILE_ENDPOINT }).update(data);
